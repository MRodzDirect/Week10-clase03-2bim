...
public abstract class Estudiante {
    ...
    public String toString() {
        ...
        sb.append("nombresEstudiante=").append(nombresEstudiante);
        sb.append(", apellidosEstudiante=").append(apellidosEstudiante);
        sb.append(", identificacionEstudiante=").append(identificacionEstudiante);
        sb.append(", edadEstudiante=").append(edadEstudiante);
